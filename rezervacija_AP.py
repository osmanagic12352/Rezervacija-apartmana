...
label3 = Label(master, bg="#efd5a8", font=("Helvetica 8"), text="Izbrisati rezervaciju tako što \nupišete u polje ime i prezime osobu od \nželjene rezervacije koju želite izbrisat. \ni Nakon toga stisnete \n'izbrišite rezervaciju' \ni ponovo pokrenite aplikaciju")
label3.place(relx=0.84, rely=0.84, relwidth=0.16, relheight=0.15)
